        ...
        <div className="bg-white dark:bg-neutral-800  dark:shadow-neutral-900 relative  w-[95%] lg:w-full mx-auto text-center rounded-3xl shadow-lg content">
          <div className="flex flex-col  pb-4">
            <img
              ...
              src={product}
            />
            <header className="flex flex-row px-6 justify-between">
              <h2 className="font-bold mt-6 text-xl">Duplex House</h2>
              <span className="font-bold mt-6 text-xl text-secondary">
                $ 140.000
              </span>
            </header>
            <section className="flex flex-col w-full px-6 mt-2 border-spacing-2 ">
              ...
              <ul className="flex flex-row gap-4 mt-4">
                <li className="flex flex-row gap-3 text-primary">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="fill-current h-6 w-6 rounded-md border-2 border-primary box-border p-[0.1rem]"
                    fill="currentColor"
                    viewBox="0 0 16 16"
                  >
                ...
                <li className="flex flex-row gap-3 text-primary     ">
                  ...
                  <span className="text-lg">1200 sqft</span>
                </li>
              </ul>
            </section>
            <div className="mt-4 border-t-2 border-gray-300 mx-6 items-center flex flex-row justify-between">
              <div className="flex flex-row gap-3 mt-3 text-gray-400">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-xl mt-2 hover:text-primary ">Rafi</span>
              </div>
              <div className="flex flex-row gap-3 mt-5 text-gray-400">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
