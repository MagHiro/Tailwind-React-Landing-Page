...
export default function Home() {
  return (
    <div className="container max-w-6xl mx-auto px-1">
      <div className="bg-blue-200 dark:bg-neutral-700 dark:opacity-20 h-[820px] md:h-[820px] lg:h-[570px] opacity-20 absolute z-1 bg-cover left-0 right-0"></div>
      <div className="px-5 pt-16 z-50 relative flex flex-col-reverse gap-20 md:flex-row lg:flex-row lg:space-y-0 lg:pt-36 lg:flex lg:justify-between">
        <h1 className="text-left dark:text-white font-bold tracking-wide text-6xl leading-snug">
      ...
      <div className="text-gray-400 dark:text-gray-200 px-5 py-12 lg:px-20 z-50 text-center relative">
